...
<section class="home">
   ...
   <div class="content">
      <h3> Fashion Shop</h3>
      <p>Cửa Hàng Thời TRang Hàng Đầu  </p>
...
<section class="products">
   ...
   <div class="load-more" style="margin-top: 2rem; text-align:center">
      <a href="shop.php" class="option-btn">Nhiều HƠn</a>
   </div>
...
<section class="home-contact">
   ...
   <div class="content">
      <h3>Bạn Có Gì muốn Hỏi ?</h3>
      <p></p>
      <a href="contact.php" class="white-btn">NHận Xét Ngay</a>
   </div>
